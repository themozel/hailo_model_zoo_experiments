...
class Exp(MyExp):
    def __init__(self):
        ...
        # ### GERALD-cropped dataset configuration
        # self.data_dir = "/data/GERALD-cropped/"
        # self.train_ann = "instances_train2017.json"
        # self.val_ann = "instances_val2017.json"
        # self.test_ann = "instances_test2017.json"
        # self.input_size = (704, 704)  # (height, width); both dims multiples of 32
        # self.test_size = (704, 704)
        # self.num_classes = 60  # Set this to the number of classes in your dataset
        # self.data_num_workers = 6

        ### Zeus-cropped dataset configuration
        self.data_dir = "/data/zeus-cropped/"
        self.train_ann = "instances_train2017.json"
        self.val_ann = "instances_val2017.json"
        self.test_ann = "instances_test2017.json"
        # Zeus-cropped images are ~688x688 (some 672x688) — use this pair instead if switching datasets
        self.input_size = (704, 704)  # (height, width); both dims multiples of 32, >= largest crop dim
        self.test_size = (704, 704)
        self.num_classes = 33  # Set this to the number of classes in your dataset
        self.data_num_workers = 6

        # ### GERALD-cropped dataset configuration, >=129-instance class subset
        # Same images as GERALD-cropped above, but only the 31 (of 60) classes with
        # >=129 annotated instances across train+val+test are kept (category IDs
        # remapped to a contiguous 1-31). Rare classes (e.g. ICE, LZB, Lf_2) were
        # getting near-zero/undefined AP — see
        # inference_results/yolox-vs-damoyolo-GERALD-cropped/comparison.md. Generated by
        # filtering data/GERALD-cropped/annotations/instances_*2017.json.
        # self.data_dir = "/data/GERALD-cropped/"
